...
date: 2023-05-16
categories: [Theory, Probability, Modeling, Machine-Learning]
---
...
![Figure 1. State Diagram of the Bernoulli trials with and without Markov property.](state_diagram.png)
...
![Figure 2. Maximum Likelihood Estimate of p for Bernoulli Coin with different models](bernoulli_data.png)
...
![Figure 3. Maximum Likelihood Estimate of p for Markov Coin with different models](markov_data.png)
...
![Figure 4. Maximum Likelihood Estimate of delta for both coins with Markov Model](delta.png)
